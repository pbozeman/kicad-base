...
Note: In2 is power to increase the capacitance between it an Gnd1/In1.
...
* Minimum via diameter: 0.4 (for low cost, higher cost is 0.2)
* Hole to hole: 0.2mm
* Track width: 3.5mil, 3 ok when doing bga fanout (<3.5 carries an extra cost)
